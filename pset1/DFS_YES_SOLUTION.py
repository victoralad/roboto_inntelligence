...
def DFS_visited_list(start_node, goal_node, graph):
	"""
	...
	visited_list = [start_node]  # initialize the visited list with start node
...
if __name__ == "__main__":
	start = time.time()
	path, nodes_popped, max_queue_size = DFS_visited_list("WA", "GA", graph)
	stop = time.time()
	runtime = stop - start
